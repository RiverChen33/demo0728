...
export default class ZhengGai extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <ScrollView style={{flex:1}}>
                <FlatList
                    ...
                    <TouchableOpacity style={{flex:1}} onPress={()=>{this.props.navigation.navigate("ZhengGaiDetail",{id:item.id})}}>
                        <View style={styles.container}>
                            <View style={{flex:5}}>
                                ...
                                <View style={{flexDirection:'row',height:30,alignContent:'center'}}>
                                    <Text style={{fontSize:14,lineHeight:30,}}>整改期限：{item.date}</Text>
                                </View>
                            </View>
