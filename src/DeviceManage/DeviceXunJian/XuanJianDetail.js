...
var index=0;
export default class XuanJianDetail extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            detail: {
                id: '201', class: '楼内楼梯扶手、栏杆、窗台', desc: '问题', date: '2018-01-05', status: '整改中',
                ...
                <View style={{flex: 1}}>
                    ...
                    <View style={{backgroundColor: 'white', paddingRight: 10, paddingLeft: 10, marginBottom: 10}}>
                        <View style={{height: 40, justifyContent: 'center'}}>
                            <Text style={{fontSize: 16, fontWeight: '600'}}>巡检项目{this.state.detail.class}</Text>
                        </View>
                        <View style={{height: 40, justifyContent: 'center',}}>
                            <Text style={{color: '#929292', fontSize: 14}}>巡检时间：{this.state.detail.desc}</Text>
                        </View>
                        <View style={{height: 40, justifyContent: 'center', color: '#929292', fontSize: 14}}>
                            <Text style={{color: '#929292', fontSize: 14}}>巡检方法：{this.state.detail.date}</Text>
                        </View>
                        <View style={{height: 40, justifyContent: 'center', color: '#929292', fontSize: 14}}>
                            <Text style={{color: '#929292', fontSize: 14}}>巡检要求：{this.state.detail.date}</Text>
                        </View>
                        <View style={{
                            height: 40,
                            ...
                            <Text style={{color: '#929292', fontSize: 14}}>巡检结果：</Text>
                            <RadioGroup selectedIndex={0}
                                        onSelect={(index, value) => this.setState({timeflag: value})} style={{
                                flexDirection: 'row',
                                flex: 1,
                                justifyContent: 'center',
                                alignSelf: 'flex-end'
                    ...
                    <View style={{backgroundColor: 'white', paddingRight: 10, paddingLeft: 10,paddingTop: 10}}>
                        <Text style={{fontSize: 16, fontWeight: '600'}}>详细说明</Text>
                        <View style={{
                            height: 80,
                            justifyContent: 'center',
                            flexDirection: 'row',
                            ...
                            <TextInput placeholder="请填写说明" underlineColorAndroid='transparent'
                                       onChangeText={(text) => this.setState({content: text})}
                                       style={{flex: 1, fontSize: 16, color: '#565656'}} multiline={true}/>
                        </View>
                        <View
                            style={{alignSelf: 'flex-start', flexDirection: 'row', paddingBottom: 10, paddingTop: 10}}>
                                ...
                                <FlatList
                                    ...
                                    renderItem={({item}) =>
                                        <View style={{
                                            ...
                                            <TouchableOpacity onPress={() => this.deleteImg(item.index)}
