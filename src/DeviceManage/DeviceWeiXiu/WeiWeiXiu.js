...
import {
    ...
    StyleSheet,
    Text,
    View,ScrollView,FlatList,Image,StatusBar,TouchableOpacity,Linking
} from 'react-native';
...
export default class WeiWeiXiu extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = {
            list: [{id: '201', class: '楼内楼梯扶手、栏杆、窗台', date: '2018-01-05', status: '考评中', tel: '955555'},
                {id: '202', class: '楼内楼梯扶手、栏杆、窗台', desc: '环境问题', date: '2018-01-05', status: '整改中', tel: '955555'},
                {id: '203', class: '环境投诉', desc: '环境问题', date: '2018-01-05', status: '验收通过', tel: '955555'},
                {id: '203', class: '环境投诉', desc: '环境问题', date: '2018-01-05', status: '验收通过', tel: '955555'},
                {id: '203', class: '环境投诉', desc: '环境问题', date: '2018-01-05', status: '验收通过', tel: '955555'},
                {id: '203', class: '环境投诉', desc: '环境问题', date: '2018-01-05', status: '验收通过', tel: '955555'},
                {id: '203', class: '环境投诉', desc: '环境问题', date: '2018-01-05', status: '验收通过', tel: '955555'},
                {id: '203', class: '环境投诉', desc: '环境问题', date: '2018-01-05', status: '验收通过', tel: '955555'},
                {id: '203', class: '环境投诉', desc: '环境问题', date: '2018-01-05', status: '验收通过', tel: '955555'},
                {id: '204', class: '环境投诉', desc: '环境问题', date: '2018-01-05', status: '整改中', tel: '955555'}],
            alertInfo: {
                showAlert: false,
                title: '温馨提示',
                message: '提交成功',
        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View style={{height: 40, width: width, justifyContent: 'center', flexDirection: 'row'}}>
                    <TouchableOpacity onPress={() => this.props.navigation.navigate("WeiXiuDengJi")} style={{
                        height: 40,
                        alignItems: 'center',
                        justifyContent: 'center',
                        flex: 1,
                ...
                <AwesomeAlert
                    ...
                    showCancelButton={this.state.alertInfo.confirm}
                    showConfirmButton={this.state.alertInfo.confirm}
                    cancelText="取消"
                    confirmText="确定"
    ...
    start=()=>{
        ...
        let resetAction = NavigationActions.reset({
            index: 0,
            actions: [
                NavigationActions.navigate({routeName:'WeiXiuTab'})//要跳转到的页面名字
            ]
        });
