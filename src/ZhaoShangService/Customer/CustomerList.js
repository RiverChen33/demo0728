                                ...
                                <View style={styles.container}>
                                    <View style={{flex:5}}>
                                        <View style={{flexDirection:'row',height:40,alignItems:'center'}}>
                                            ...
                                            <Text style={{fontSize:14,textAlign:'center',color:'white',height:20,backgroundColor:'#4083FF',alignSelf:'center',marginLeft:5}}>{item.status}</Text>
                                        </View>
                                        <View style={{flexDirection:'row',height:40,alignItems:'center'}}>
                                            <Text style={{fontSize:16,lineHeight:40,color:'#383838'}}>手机号：{item.date}</Text>
                                        </View>
                                    </View>
